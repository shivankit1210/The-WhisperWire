  ...
  return (
    <div className="detail p-2">
      <div className="user py-3 flex flex-col border-b border-gray-400 place-content-center items-center">
        <img className="w-16 h-16 rounded-full" src="./avatar.png" alt="" />
        <h1 className="text-white">Shivankit Agarwal</h1>
        ...
        <div className="option py-2">
          ...
          <div className="photos">
            <div className="photoItem flex justify-between py-3 items-center">
              ...
              <img  className="w-5 h-5 p-1 bg-blue-900 rounded-sm " src="./download.png" alt="" />
            </div>
      ...
      <div className="option">
        <div className="title flex justify-between">
          ...
          <img className="w-5 h-5 bg-blue-900 rounded-full p-1" src="./arrowUp.png" alt="" />
        </div>
      </div>
